  ...
  return (
    <Screen isLoading={isLoading} keyboardAware={true}>
      <View style={styles.container}>
        ...
        <AppText style={{marginTop:30,color:'grey'}}>{'Please add your delivery address in order to view ' + (territory_type && territory_type != "address" ? territory_type : 'restaurants') + ' located nearby.'}{addressCnt > 0 && <AppText style={{fontWeight: "bold", color:'black'}}>Start by selecting your country</AppText>}</AppText>
        <View>
          {/* <Input
